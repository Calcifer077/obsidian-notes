...
published:
created: 2026-06-05
description: In this note you will learn about how to promisify a callback
tags:
  - javascript
---
...
For instance, we have `loadScript(src, callback)` from the chapter [Callbacks](Callbacks.md).
