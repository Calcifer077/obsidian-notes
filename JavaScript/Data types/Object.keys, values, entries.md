...
tags:
  - javascript
---
The methods like `map.keys()`, `map.values()`, `map.entries()` are generic, there is a common agreement to use them for data structures. If we every create a data structure of our own, we should implement them too.
