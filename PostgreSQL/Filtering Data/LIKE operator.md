...
source: https://neon.com/postgresql/tutorial/like
created: 2026-06-05
description: This tutorial shows you how to use the PostgreSQL LIKE and ILIKE operators to query data based on patterns.
tags:
  - database
  - postgresql
---
...
- Underscore sign (`_`) matches any single character. Can't be a empty string.
...
### 3) Using with a pattern that contains both wildcards
...
## Extensions of the LIKE operator
...
Let’s [create a simple table](https://neon.com/postgresql/tutorial/postgresql-create-table) for demonstration:
