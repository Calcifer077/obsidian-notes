...
source: https://neon.com/postgresql/tutorial/is-null
author:
  - "[[Neon]]"
published:
created: 2026-06-05
description: In this tutorial, you will learn how to use the PostgreSQL IS NULL operator to check if a value is NULL or not.
tags:
  - database
  - postgresql
---
...
To learn how to deal with NULL in sorting, check out the [ORDER BY](../Querying%20Data/ORDER%20BY.md).

PostgreSQL offers some useful functions to handle NULL effectively such as [NULLIF](https://neon.com/postgresql/tutorial/postgresql-nullif), [ISNULL](https://neon.com/postgresql/tutorial/postgresql-isnull), and [COALESCE](https://neon.com/postgresql/tutorial/postgresql-coalesce).

To ensure that a column does not contain NULL, you use the [NOT NULL constraint](https://neon.com/postgresql/tutorial/postgresql-not-null-constraint).

## Examples

We’ll use the `address` table from the [sample database](https://neon.com/postgresql/postgresql-getting-started/postgresql-sample-database):

![](../../assets/address_table_querying_data_select_statement_neon_postgre_sql_tutorial.png) 
...
To fix it, you can use the `UPDATE` statement to change the empty strings to NULL in the `address2` column.
